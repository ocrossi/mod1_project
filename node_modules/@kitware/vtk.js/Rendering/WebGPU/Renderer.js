import { obj, get, getArray, setGet, newInstance as newInstance$1, vtkDebugMacro as vtkDebugMacro$1 } from '../../macro.js';
import { A as clampValue } from '../../Common/Core/Math/index.js';
...
import { b as scale, i as add, p as sub, q as len } from '../../vendor/gl-matrix/esm/vec3.js';
...
function vtkWebGPURenderer(publicAPI, model) {
  ...
  publicAPI.getTiledSizeAndOrigin = function () {
    ...
    var vpu = clampValue(vport[0] - tileViewPort[0], 0.0, 1.0);
    var vpv = clampValue(vport[1] - tileViewPort[1], 0.0, 1.0); // store the result as a pixel value
    ...
    var vpu2 = clampValue(vport[2] - tileViewPort[0], 0.0, 1.0);
    var vpv2 = clampValue(vport[3] - tileViewPort[1], 0.0, 1.0); // also watch for the upper right boundary of the tile
