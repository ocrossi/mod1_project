...
import { obj, setGet, newInstance as newInstance$1, vtkWarningMacro as vtkWarningMacro$1, vtkErrorMacro as vtkErrorMacro$1 } from '../../macro.js';
...
import { s as set, l as length, t as transformMat4, n as normalize, b as scale, m as divide, o as transformMat3, d as dot } from '../../vendor/gl-matrix/esm/vec3.js';
...
function vtkOpenGLVolumeMapper(publicAPI, model) {
  ...
  publicAPI.replaceShaderValues = function (shaders, ren, actor) {
    ...
    var averageIPScalarRange = model.renderable.getAverageIPScalarRange();
    var min = averageIPScalarRange[0];
    var max = averageIPScalarRange[1]; // If min or max is not already a float.
    ...
    FSSource = vtkShaderProgram.substitute(FSSource, '//VTK::AverageIPScalarRangeMin', min).result;
    FSSource = vtkShaderProgram.substitute(FSSource, '//VTK::AverageIPScalarRangeMax', max).result;
