...
function vtkOpenGLVolumeMapper(publicAPI, model) {
  ...
  publicAPI.replaceShaderValues = function (shaders, ren, actor) {
    ...
    FSSource = vtkShaderProgram.substitute(FSSource, '//VTK::IPScalarRangeMin', min).result;
    FSSource = vtkShaderProgram.substitute(FSSource, '//VTK::IPScalarRangeMax', max).result;
