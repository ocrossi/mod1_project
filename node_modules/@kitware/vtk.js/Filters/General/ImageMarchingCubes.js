...
function vtkImageMarchingCubes(publicAPI, model) {
  ...
  publicAPI.getVoxelPoints = function (i, j, k, dims, origin, spacing) {
  ...
  publicAPI.produceTriangles = function (cVal, i, j, k, slice, dims, origin, spacing, scalars, points, tris, normals) {
...
export default vtkImageMarchingCubes$1;
