...
function vtkTextureMapToPlane(publicAPI, model) {
  ...
  function computeNormal(output) {
    ...
    matrix[1] = c2;
    matrix[2] = c3;
    model.normal[0] = determinant3x3(matrix) / det;
    matrix[0] = c1;
    matrix[1] = v;
    matrix[2] = c3;
...
function extend(publicAPI, model) {
  ...
  macro.setGetArray(publicAPI, model, ['origin', 'point1', 'point2', 'normal', 'sRange', 'tRange'], 3);
...
export default vtkTextureMapToPlane$1;
