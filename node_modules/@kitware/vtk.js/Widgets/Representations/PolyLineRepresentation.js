...
function vtkPolyLineRepresentation(publicAPI, model) {
  ...
  publicAPI.requestData = function (inData, outData) {
    ...
    var list = publicAPI.getRepresentationStates(state).reduce(function (subStates, subState) {
      var subStateOrigin = subState.getOrigin && subState.getOrigin().length ? subState.getOrigin() : null;
  ...
  publicAPI.updateActorVisibility = function (renderingType, wVisible, ctxVisible, hVisible) {
    ...
    return superClass.updateActorVisibility(renderingType, wVisible && isValid, ctxVisible && isValid, hVisible && isValid);
  };
} // ----------------------------------------------------------------------------
// Object factory
// ----------------------------------------------------------------------------
...
export default vtkPolyLineRepresentation$1;
