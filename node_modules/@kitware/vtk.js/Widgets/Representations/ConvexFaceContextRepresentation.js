...
function vtkConvexFaceContextRepresentation(publicAPI, model) {
  ...
  publicAPI.requestData = function (inData, outData) {
    ...
    var points = allocateSize(list.length);
  ...
  publicAPI.updateActorVisibility = function () {
    ...
    superUpdateActorVisibility(renderingType, widgetVisible, ctxVisible, handleVisible);
  };
} // ----------------------------------------------------------------------------
// Object factory
// ----------------------------------------------------------------------------
...
export default vtkConvexFaceContextRepresentation$1;
