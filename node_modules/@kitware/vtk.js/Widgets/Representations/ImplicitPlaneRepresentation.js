...
function vtkImplicitPlaneRepresentation(publicAPI, model) {
  ...
  publicAPI.updateActorVisibility = function (renderingType, wVisible, ctxVisible, hVisible) {
    ...
    if (renderingType === RenderingTypes.PICKING_BUFFER) {
      ...
      model.pipelines.outline.actor.setVisibility(outlineVisible && wVisible && ctxVisible);
      model.pipelines.plane.actor.setVisibility(planeVisible && wVisible && hVisible);
      model.pipelines.origin.actor.setVisibility(originVisible && wVisible && hVisible);
      model.pipelines.normal.actor.setVisibility(normalVisible && wVisible && hVisible); //
...
export default vtkImplicitPlaneRepresentation$1;
