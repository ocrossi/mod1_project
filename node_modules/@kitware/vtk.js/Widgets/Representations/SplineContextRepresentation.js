...
function vtkSplineContextRepresentation(publicAPI, model) {
  ...
  publicAPI.requestData = function (inData, outData) {
    ...
    var list = publicAPI.getRepresentationStates(widgetState).filter(function (state) {
      return state.getVisible && state.getVisible();
    });
...
function extend(publicAPI, model) {
  ...
  macro.setGet(publicAPI, model, ['resolution', 'close', 'fill', 'outputBorder', 'borderColor', 'errorBorderColor']); // Object specific methods
...
export default vtkSplineContextRepresentation$1;
