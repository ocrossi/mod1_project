...
function vtkSplineWidget(publicAPI, model) {
  ...
  model.moveHandle = model.widgetState.getMoveHandle(); // Default manipulator
...
function extend(publicAPI, model) {
  ...
  macro.setGet(publicAPI, model, ['manipulator', 'freehandMinDistance', 'allowFreehand', 'resolution', 'defaultCursor', 'handleSizeInPixels']);
...
export default vtkSplineWidget$1;
