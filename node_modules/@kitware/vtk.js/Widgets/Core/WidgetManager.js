...
function vtkWidgetManager(publicAPI, model) {
  ...
  function updateDisplayScaleParams() {
    ...
    if (renderer && apiSpecificRenderWindow && camera) {
      ...
      var dispHeightFactor = isParallel ? camera.getParallelScale() : 2 * Math.tan(radiansFromDegrees(camera.getViewAngle()) / 2);
...
export default vtkWidgetManager$1;
export { extend, extractRenderingComponents, newInstance };
