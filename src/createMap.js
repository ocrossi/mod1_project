...
import {sort_input_tab, translate_map} from './mapUtils.js'
...
function create_map(mapData) {
	...
	mapData.size_map = Math.max(mapData.bounds[2] - mapData.bounds[0], mapData.bounds[3] - mapData.bounds[1]);
	translate_map(-mapData.bounds[0], -mapData.bounds[1], mapData); // moves points into whole natural numbers system
}
