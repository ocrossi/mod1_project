...
function Skybox(e, t) {
    ...
    n.scale(-1, 1, 1);
    var i = new SkyMaterial({ envMap: e });
...
function SPH(e, t, n, i, r, o, a, s) {
    (this._setup = o),
        ...
        (this._particleRadius = 0.5 * Math.pow((3 * this._particleMass) / (4 * Math.PI * this._restDensity), 1 / 3)),
        (this._restDistance = 0.1 * this._smoothingRadius),
        ...
        this._halfExtent.multiplyScalar(0.5),
...
function VolumetricLighting(e, t, n, i) {
    ...
    var o = e.y * t * 0.25,
        a = THREE.UniformsUtils.merge([
            {
                densityField: { value: null },
                cameraPos: { value: new THREE.Vector3() },
                mieG: { value: new THREE.Color(-0.1, -0.12, 0.05) },
                cellSize: { value: t },
                absorption: { value: new THREE.Color(0.01, 0.01, 0.01) },
                numCells: { value: e },
                sampleStep: { value: o / (n - 1) },
            },
            THREE.UniformsLib.lights,
        ]);
    THREE.ShaderMaterial.call(this, { defines: r, uniforms: a, lights: !0, vertexShader: ShaderLibrary.get("volumetric_vertex"), fragmentShader: ShaderLibrary.get("volumetric_lighting_fragment") });
}
function VolumetricLightRenderer(e, t, n, i, r, o) {
    (this._target = new THREE.WebGLRenderTarget(t.x * t.z * o, t.y * o, { minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, generateMipmaps: !1, depthBuffer: !1, stencilBuffer: !1, format: THREE.RGBAFormat })),
        (this._renderer = e),
...
function VolumetricNormals(e, t, n) {
    var i = THREE.UniformsUtils.merge([{ densityField: { value: null }, numCells: { value: new THREE.Vector3(e, t, n) }, rcpTexSize: { value: new THREE.Vector3(1 / (e * n), 1 / t) } }]);
    THREE.ShaderMaterial.call(this, { uniforms: i, vertexShader: ShaderLibrary.get("volumetric_vertex"), fragmentShader: ShaderLibrary.get("volumetric_normals_fragment") });
}
...
(THREE.EffectComposer = function (e, t) {
    if (((this.renderer = e), void 0 === t)) {
        var n = { minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat, stencilBuffer: !1 },
            i = e.getSize();
...
(THREEx.RendererStats = function () {
    ...
    for (var i = [], r = 9, o = 0; o < r; o++)
        (i[o] = document.createElement("div")), (i[o].style.cssText = "color:#f00;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px"), t.appendChild(i[o]), (i[o].innerHTML = "-");
    var a = Date.now();
    return {
        domElement: e,
        update: function (e) {
    ...
    (THREE.ShaderPass = function (e, t) {
        THREE.Pass.call(this),
            ...
            e instanceof THREE.ShaderMaterial
                ...
                : e &&
                  ((this.uniforms = THREE.UniformsUtils.clone(e.uniforms)), (this.material = new THREE.ShaderMaterial({ defines: e.defines || {}, uniforms: this.uniforms, vertexShader: e.vertexShader, fragmentShader: e.fragmentShader }))),
    ...
    (AsyncTaskQueue.prototype = {
        queue: function (e, t) {
            ...
            this._queue.push({ func: e, args: n.slice(1) });
        },
    ...
    (Axes.prototype._init = function () {
        ...
        e.translate(0, 0.5, 0);
        var t = new THREE.Mesh(e, new UnlitMaterial({ color: 16711680 })),
            n = new THREE.Mesh(e, new UnlitMaterial({ color: 65280 })),
            i = new THREE.Mesh(e, new UnlitMaterial({ color: 255 }));
        (t.rotation.z = 0.5 * -Math.PI), (i.rotation.x = 0.5 * Math.PI), this.add(t), this.add(n), this.add(i);
    }),
    (CalculateNormals = {
        doAll: function (e) {
...
(RectRenderer.prototype = {
    ...
    (EntityEngine.prototype = {
        ...
        _addUpdatableEntity: function (e) {
            this._updateQueue.push({ entity: e, updatable: !0 });
        },
        _removeUpdatableEntity: function (e) {
            this._updateQueue.push({ entity: e, updatable: !1 });
        },
    ...
    (ShaderLibrary["bilat_gaussian_blur_fragment.glsl"] =
    ...
    (ShaderLibrary["gaussian_blur_enc_float_fragment.glsl"] =
    ...
    (ShaderLibrary["gaussian_blur_fragment.glsl"] =
    ...
    (ShaderLibrary["debug_vec3_vertex.glsl"] =
        "varying vec2 texCoords;\n\nvoid main() {\n    vec3 localPos = position;\n    vec4 viewPos = modelViewMatrix * vec4(localPos, 1.0);\n    gl_Position = projectionMatrix * viewPos;\n    texCoords = uv;\n}"),
    (ShaderLibrary["dielectric_fragment.glsl"] =
    ...
    (ShaderLibrary["dielectric_vertex.glsl"] =
    ...
    (ShaderLibrary["glass_fragment.glsl"] =
    ...
    (ShaderLibrary["glass_vertex.glsl"] =
    ...
    (ShaderLibrary["volumetric_normals_fragment.glsl"] =
    ...
    (ShaderLibrary["include_sph.glsl"] =
    ...
    (ShaderLibrary["sph_accel_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_ball_collider_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_bucket_vertex.glsl"] =
    ...
    (ShaderLibrary["sph_density_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_distance_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_distance_vertex.glsl"] =
    ...
    (ShaderLibrary["sph_heightmap_collider_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_particle_depth_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_particle_depth_vertex.glsl"] =
    ...
    (ShaderLibrary["sph_particle_point_fragment.glsl"] =
        "#ifdef MAP\nuniform sampler2D colorBuffer;\n\nvarying vec2 texCoords;\n#endif\n\nvoid main() {\n#ifdef MAP\n    gl_FragColor.xyz = (.5 + length(texture2D(colorBuffer, texCoords).xyz)) * vec3(.5, .8, 1.0) * .5;\n    gl_FragColor.w = 1.0;\n#else\n    gl_FragColor = vec4(1.0);\n#endif\n}\n"),
    (ShaderLibrary["sph_particle_point_vertex.glsl"] =
        "attribute vec2 positionUV;\n\nuniform sampler2D positionBuffer;\nuniform float particleSize;\n\n#ifdef MAP\nvarying vec2 texCoords;\n#endif\n\nvoid main() {\n    vec4 localPos = vec4(texture2D(positionBuffer, positionUV).xyz, 1.0);\n    vec4 viewPos = modelViewMatrix * localPos;\n    gl_Position = projectionMatrix * viewPos;\n    gl_PointSize = particleSize;\n\n    #ifdef MAP\n    texCoords = positionUV;\n    #endif\n\n}"),
    (ShaderLibrary["sph_position_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_velocity_fragment.glsl"] =
    ...
    (ShaderLibrary["sph_wall_collider_fragment.glsl"] =
...
var highPerformance,
    mainProject,
    assetLibrary,
    debugMode = QueryString.debug && "0" !== QueryString.debug && "false" !== QueryString.debug;
(window.onload = startUp),
    ...
    (AssetLibrary.Type = { JSON: 0, MODEL: 1, TEXTURE_2D: 2, TEXTURE_CUBE: 3, PLAIN_TEXT: 4 }),
    (AssetLibrary.prototype = {
        ...
        queueAsset: function (e, t, n, i) {
            this._queue.push({ id: e, filename: this._basePath + t, type: n, parser: i });
        },
        load: function () {
    ...
    (OrbitController = function (e, t, n) {
        Component.call(this),
            (this.enabled = !0),
            (this._container = e),
            (this._coords = new THREE.Vector3(0, 0.4 * Math.PI, 2)),
    ...
    (DebugAlphaMaterial = function (e) {
        var t = { map: { value: e } };
        THREE.ShaderMaterial.call(this, { uniforms: t, vertexShader: ShaderLibrary.get("debug_alpha_vertex"), fragmentShader: ShaderLibrary.get("debug_alpha_fragment") });
    }),
    ...
    (DebugVec3Material = function (e) {
        var t = { map: { value: e } };
        THREE.ShaderMaterial.call(this, { uniforms: t, vertexShader: ShaderLibrary.get("debug_vec3_vertex"), fragmentShader: ShaderLibrary.get("debug_vec3_fragment") });
    }),
    ...
    (DielectricMaterial = function (e) {
        ...
        e.displacementMap && (t += "#define DISPLACEMENT_MAP\n"),
            ...
            (e.roughness = void 0 === e.roughness ? 0.05 : e.roughness),
        ...
        var n = {
                alpha: { value: 1 },
                fogProbe: { value: e.fogProbe },
                fogProbeBoost: { value: e.fogProbeBoost ? Math.pow(2, e.fogProbeBoost) : 1 },
                fogDensity: { value: e.fogDensity || 0.1 },
                fogColor: { value: e.fogColor },
                displacementMap: { value: e.displacementMap },
                displacementMapRange: { value: e.displacementMapRange },
                albedoMap: { value: e.map },
                color: { value: e.color },
                celSpecularCutOff: { value: e.celSpecularCutOff || 1 },
                roughness: { value: e.roughness },
                normalSpecularReflection: { value: 0.027 },
                normalMap: { value: e.normalMap },
                emissionMap: { value: e.emissionMap },
                emissionColor: { value: e.emissionColor },
                roughnessMap: { value: e.roughnessMap },
                roughnessMapRange: { value: e.roughnessMapRange || 0.3 },
                aoMap: { value: e.aoMap },
                skyboxPosition: { value: e.skyboxPosition ? e.skyboxPosition : new THREE.Vector3() },
                skyboxSize: { value: e.skyboxSize ? e.skyboxSize : 10 },
                specularProbe: { value: e.specularProbe },
                specularProbeColor: { value: e.specularProbeColor },
                irradianceProbe: { value: e.irradianceProbe },
                irradianceProbeBoost: { value: e.irradianceProbeBoost ? Math.pow(2, e.irradianceProbeBoost) : 1 },
            },
            i = e.ignoreLights ? n : THREE.UniformsUtils.merge([n, THREE.UniformsLib.lights]);
        THREE.ShaderMaterial.call(this, { uniforms: i, lights: !e.ignoreLights, vertexShader: t + ShaderLibrary.get("dielectric_vertex"), fragmentShader: t + ShaderLibrary.get("dielectric_fragment") }),
    ...
    (GlassMaterial = function (e) {
        var t = "";
        e.specularProbe && (t += "#define SPECULAR_PROBE\n"), (e.roughness = void 0 === e.roughness ? 0.05 : e.roughness);
        var n = { roughness: { value: e.roughness }, normalSpecularReflection: { value: 0.027 }, specularProbe: { value: e.specularProbe } },
            i = THREE.UniformsUtils.merge([n, THREE.UniformsLib.lights]);
        THREE.ShaderMaterial.call(this, { uniforms: i, lights: !0, vertexShader: t + ShaderLibrary.get("glass_vertex"), fragmentShader: t + ShaderLibrary.get("glass_fragment") }),
            e.specularProbe && (this.uniforms.specularProbe.value = e.specularProbe),
            (this.transparent = !0),
    ...
    (LinearDepthMaterial = function () {
        THREE.ShaderMaterial.call(this, { uniforms: { cameraNear: { value: 0 }, rcpCameraRange: { value: 0 } }, vertexShader: ShaderLibrary.get("linear_depth_vertex"), fragmentShader: ShaderLibrary.get("linear_depth_fragment") });
    }),
    ...
    (SkyMaterial = function (e) {
        ...
        var t = { envMap: { value: this._envMap }, color: { value: this._color }, invert: { value: 1 } };
        THREE.ShaderMaterial.call(this, { uniforms: t, vertexShader: ShaderLibrary.get("sky_vertex"), fragmentShader: ShaderLibrary.get("sky_fragment") });
    }),
    ...
    (RenderVolumeMaterial = function (e, t, n) {
        ...
        t && (i.SKYBOX = "");
        var r = {
                lightAccum: { value: null },
                waterDepthMap: { value: null },
                sceneDepthMap: { value: null },
                pixelSize: { value: new THREE.Vector2() },
                numCells: { value: e.numCells },
                ...
                normalSpecularReflection: { value: 0.04 },
                cameraNear: { value: 0 },
                cameraRange: { value: 1 },
                transparencyFactor: { value: 10 },
                absorption: { value: new THREE.Color(0.01, 0.01, 0.01) },
                mie: { value: new THREE.Color(-0.1, -0.12, 0.05) },
                skybox: { value: t },
            },
            o = THREE.UniformsUtils.merge([r, THREE.UniformsLib.lights]);
        THREE.ShaderMaterial.call(this, { defines: i, uniforms: o, lights: !0, vertexShader: ShaderLibrary.get("render_volume_vertex"), fragmentShader: ShaderLibrary.get("render_volume_fragment") }),
    ...
    (SPHParticlePointMaterial = function (e) {
        ...
        e && (t.MAP = ""),
            THREE.ShaderMaterial.call(this, {
                defines: t,
                uniforms: { colorBuffer: { value: e }, positionBuffer: { value: null }, particleSize: { value: 10 } },
    ...
    (UnlitMaterial = function (e) {
        ...
        var n = { color: { value: e.color || new THREE.Color(1, 1, 1) }, albedoMap: { value: e.map }, opacity: { value: void 0 === e.opacity ? 1 : e.opacity }, fogDensity: { value: e.fogDensity || 0.1 }, fogColor: { value: e.fogColor } };
        THREE.ShaderMaterial.call(this, { uniforms: n, vertexShader: t + ShaderLibrary.get("unlit_vertex"), fragmentShader: t + ShaderLibrary.get("unlit_fragment") }),
            e.blending &&
                ((this.blending = e.blending),
                (this.transparent = !0),
                e.blending === THREE.AdditiveBlending &&
                    e.hdre &&
                    ((this.blending = THREE.CustomBlending), (this.blendSrc = THREE.OneFactor), (this.blendDst = THREE.OneFactor), (this.blendSrcAlpha = THREE.ZeroFactor), (this.blendDstAlpha = THREE.ZeroFactor)),
                e.blending === THREE.NormalBlending &&
                    e.hdre &&
    ...
    (PoissonDisk = function (e, t, n, i) {
        (this._mode = void 0 === e ? PoissonDisk.CIRCULAR : e), (this._initialDistance = t || 1), (this._decayFactor = n || 0.99), (this._maxTests = i || 2e4), (this._currentDistance = 0), (this._points = null), this.reset();
    }),
    ...
    (PoissonSphere = function (e, t, n, i) {
        (this._mode = void 0 === e ? PoissonSphere.SPHERICAL : e), (this._initialDistance = t || 1), (this._decayFactor = n || 0.99), (this._maxTests = i || 2e4), (this._currentDistance = 0), (this._points = null), this.reset();
    }),
    (PoissonSphere.BOX = 0),
    ...
    (BilateralGaussianBlurShader = {
        ...
        uniforms: { tDiffuse: { value: null }, sampleStep: { value: new THREE.Vector2() }, depthRange: { value: 0.002 }, weights: { value: [] } },
        ...
        resize: function (e, t) {
            (e = Math.floor(e * this._scale)),
                ...
                (this._renderTarget && this._renderTarget.width === e && this._renderTarget.height === t) ||
                    (this._renderTarget = new THREE.WebGLRenderTarget(e, t, { type: this._textureType, minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, generateMipmaps: !1, depthBuffer: !0, stencilBuffer: !1 }));
        },
        render: function (e) {
    ...
    (SimpleThreeProject.prototype = {
        ...
        _initRenderer: function () {
            ...
            (this.renderer = new THREE.WebGLRenderer({ antialias: this._options.antialias, stencil: this._options.stencil, alpha: this._options.alpha, preserveDrawingBuffer: this._options.preserveDrawingBuffer })),
    ...
    (SPHContent.prototype = {
        init: function (e) {
            ...
            (this._spawnRatio = 0.003),
                this._mode === SPHContent.BALL_MODE ? (this._setup = new SPHBallSetup()) : this._mode === SPHContent.CASCADE_MODE && ((this._setup = new SPHCascadeSetup(this._assetLibrary.get("cascademap"))), (this._spawnRatio = 0.001)),
                (this._sph = new SPH(2, 2, 2, this._numParticles, this._volume, this._setup, this._renderer, this._quality)),
                (this._mie = new THREE.Color(-0.01, -0.01, -0.011)),
                this._mie.multiplyScalar(1.5),
                (this._fluidAbsorption = new THREE.Color(25, 3, 2)),
                this._mode === SPHContent.CASCADE_MODE && ((this._fluidAbsorption = new THREE.Color(8, 25, 23)), (this._sph.viscosity = 50), (this._sph.stiffness = 3), (this._sph.surfaceTension = 0.25)),
                this._fluidAbsorption.multiplyScalar(3),
                (this._particleDepthRenderer = new ParticleDepthRenderer(this._scene, this._renderer, this._sph, 0.5)),
                (this._sceneDepthRenderer = new SceneDepthRenderer(this._scene, this._renderer, 0.5)),
        ...
        update: function (e) {
            this._camera.updateMatrixWorld(!0),
                ...
                this._mode === SPHContent.BALL_MODE ? ((this._setup.collider.spherePosition = this._blocker.position), this._sph.update(16)) : this._sph.update(8),
        ...
        _initCameraController: function () {
            ...
            (e.azimuth = 0.5 * Math.PI),
                (e.radius = 3),
                (e.minRadius = 1),
                (e.maxRadius = 1e3),
                (e.zoomSpeed = 5),
                (e.lookAtTarget.y = -0.5),
                (e.maxPolar = 0.5 * Math.PI + 0.1),
                Entity.addComponent(this._camera, e),
                (this._cameraController = e),
                this._mode === SPHContent.CASCADE_MODE && ((e.maxAzimuth = 0.5 * Math.PI - 0.5), (e.minAzimuth = 0.5 * -Math.PI + 0.5));
        },
        ...
        _initScene: function () {
            ...
            (this._fluidMesh = new THREE.Mesh(n, this._fluidMaterial)),
                ...
                (this._lightingRenderer = new VolumetricLightRenderer(this._renderer, this._sph.numCells, this._sph.cellSize, this._numLightSamples, !0, 0.5)),
                (this._lightingRenderer.absorption = this._fluidAbsorption),
                (this._lightingRenderer.mie = this._mie),
                this._addLight(1, 0.3, 1);
        },
        _initCollider: function () {
            this._rayCaster = new THREE.Raycaster();
            var e = 0.15,
                t = new THREE.SphereBufferGeometry(e, 30, 20),
                n = new DielectricMaterial({ color: 16777215, irradianceProbe: this._assetLibrary.get("irradiance"), roughness: 0.5 });
            (this._blocker = new THREE.Mesh(t, n)),
                (this._blocker.position.y = 0.5 * -this._sph.boxSize.y + e),
        ...
        _initTerrain: function () {
            ...
            e.rotateX(0.5 * -Math.PI);
            var t = this._assetLibrary.get("cascademap");
            (t.wrapS = THREE.ClampToEdgeWrapping), (t.wrapT = THREE.ClampToEdgeWrapping);
            var n = new THREE.MeshStandardMaterial({ displacementMap: t, displacementScale: this._sph.boxSize.y, displacementBias: 0.5 * -this._sph.boxSize.y, color: 0, wireframe: !0 });
    ...
    (ParticleBlurredRenderer.prototype = {
        ...
        resize: function (e, t) {
            (e = Math.floor(e * this._scale)),
                (t = Math.floor(t * this._scale)),
                (this._renderTarget && this._renderTarget.width === e && this._renderTarget.height === t) ||
                    (this._renderTarget = new DoubleBufferTexture(e, t, { type: this._textureType, minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, generateMipmaps: !1, depthBuffer: !0, stencilBuffer: !1 }));
        },
        render: function (e) {
        ...
        _getGaussian: function (e) {
            for (var t = CenteredGaussianCurve.fromRadius(e, 0.2), n = [], i = 0, r = 0; r <= e; ++r) {
    ...
    (ParticleDepthMaterial = function () {
        THREE.ShaderMaterial.call(this, {
            uniforms: { positionBuffer: { value: null }, particleSize: { value: 100 }, viewportSize: { value: new THREE.Vector2() }, cameraNear: { value: 0.1 }, rcpCameraRange: { value: 0 } },
    ...
    (SPH.Quality = { LOW: 1, HIGH: 2, EXTREME: 2 }),
    (SPH.prototype = {
        get quality() {
        ...
        _createPointGeometry: function () {
            for (var e = new THREE.BufferGeometry(), t = [], n = [], i = [], r = this._particleBufferSize.x, o = this._particleBufferSize.y, a = 0; a < this._maxParticles; ++a) {
                var s = Math.floor(a / r),
                    l = a - s * r;
                (l = (l + 0.5) / r), (s = (s + 0.5) / o), i.push(l, s), n.push(a), t.push(a);
            }
            return (
                e.setIndex(new THREE.BufferAttribute(new Uint32Array(t), 1)),
        ...
        update: function (e, t) {
            (e *= 0.001), 0 === e && (e = 0.01), this._pointGeometry.setDrawRange(0, this._numParticles), this._setup.collider.update(), (t = 2 | t), (e /= t);
        ...
        _rtOptions: function (e) {
            return { type: THREE.FloatType, minFilter: THREE.NearestFilter, magFilter: THREE.NearestFilter, generateMipmaps: !1, depthBuffer: e || !1, stencilBuffer: e || !1, format: THREE.RGBAFormat };
        },
    }),
    (SPHAccelMaterial = function (e) {
        var t = { SAMPLE_RADIUS: e.quality, BUCKET_SIZE: 4 };
        THREE.ShaderMaterial.call(this, {
            defines: t,
            uniforms: {
                positionBuffer: { value: null },
                bucketBuffer: { value: null },
                velocityBuffer: { value: null },
                densityBuffer: { value: null },
                dt: { value: 1 },
                drag: { value: 0 },
                maxParticleIndex: { value: 0 },
                numCells: { value: e.numCells },
                cellSize: { value: e.cellSize },
                stiffness: { value: e.stiffness },
                restDensity: { value: e.restDensity },
                gravity: { value: -9.81 },
                particleBufferSize: { value: e.particleBufferSize },
                bucketPixelSize: { value: e.bucketPixelSize },
                mass: { value: e.particleMass },
                h: { value: e.smoothingRadius },
                h2: { value: Math.pow(e.smoothingRadius, 2) },
                pressNorm: { value: -45 / (Math.PI * Math.pow(e.smoothingRadius, 6)) },
                viscNorm: { value: 45 / (Math.PI * Math.pow(e.smoothingRadius, 6)) },
                surfaceNorm: { value: -945 / (32 * Math.PI * Math.pow(e.smoothingRadius, 9)) },
                curvatureThreshold: { value: e.curvatureThreshold },
                surfaceTension: { value: e.surfaceTension },
                viscosity: { value: 0 },
            },
    ...
    (SPHBallColliderMaterial = function () {
        THREE.ShaderMaterial.call(this, {
            uniforms: { wallExtent: { value: null }, numCells: { value: null }, cellSize: { value: 0 }, sphereRadius: { value: 0.2 }, spherePosition: { value: new THREE.Vector3() } },
            vertexShader: ShaderLibrary.get("sph_quad_vertex"),
    ...
    (SPHBallSetup.prototype = {
        ...
        initParticlePosition: (function (e, t, n, i) {
            ...
            return function (e, t, n, i) {
                var o = n.length() / 6;
                (r.radius = Math.random() * o), (r.phi = Math.random() * Math.PI), (r.theta = Math.random() * Math.PI * 2), i.setFromSpherical(r), (i.x -= 0.5 * n.x), (i.y += 0.5 * n.y), (i.z -= 0.5 * n.z);
            };
        })(),
    }),
    (SPHBucketMaterial = function (e) {
        THREE.ShaderMaterial.call(this, {
            uniforms: { positionBuffer: { value: null }, numCells: { value: e.numCells }, numParticles: { value: e.numParticles }, cellSize: { value: e.cellSize } },
    ...
    (SPHCascadeSetup.prototype = {
        ...
        initParticlePosition: function (e, t, n, i) {
            (i.x = -n.x * (0.2 * Math.random() + 0.8)), (i.y = 0.9 * n.y), (i.z = (2 * Math.random() - 1) * n.z * 0.2);
        },
    }),
    (SPHDensityMaterial = function (e) {
        ...
        THREE.ShaderMaterial.call(this, {
            ...
            uniforms: {
                positionBuffer: { value: null },
                collisionBuffer: { value: e.collisionBuffer },
                bucketBuffer: { value: null },
                numCells: { value: e.numCells },
                cellSize: { value: e.cellSize },
                particleBufferSize: { value: e.particleBufferSize },
                bucketPixelSize: { value: e.bucketPixelSize },
                mass: { value: e.particleMass },
                h2: { value: e.smoothingRadius * e.smoothingRadius },
                kernelNorm: { value: 315 / (64 * Math.PI * Math.pow(e.smoothingRadius, 9)) },
            },
            vertexShader: ShaderLibrary.get("sph_quad_vertex"),
    ...
    (SPHDistanceMaterial = function (e) {
        THREE.ShaderMaterial.call(this, {
            uniforms: { positionBuffer: { value: null }, numCells: { value: e.numCells }, cellSize: { value: e.cellSize }, particleRadius: { value: e.particleRadius }, zSliceOffset: { value: 0 } },
    ...
    (SPHHeightMapColliderMaterial = function (e) {
        THREE.ShaderMaterial.call(this, {
            uniforms: { numCells: { value: null }, cellSize: { value: 0 }, heightMap: { value: e }, wallExtent: { value: null } },
            vertexShader: ShaderLibrary.get("sph_quad_vertex"),
    ...
    (SPHPositionMaterial = function (e) {
        THREE.ShaderMaterial.call(this, {
            uniforms: {
                positionBuffer: { value: null },
                velocityBuffer: { value: null },
                accelBuffer: { value: null },
                dt: { value: 1 },
                wallExtent: { value: e.halfExtent },
                restDistance: { value: e.restDistance },
                maxParticleIndex: { value: 0 },
            },
            vertexShader: ShaderLibrary.get("sph_quad_vertex"),
    ...
    (SPHVelocityMaterial = function (e) {
        THREE.ShaderMaterial.call(this, {
            uniforms: {
                positionBuffer: { value: null },
                velocityBuffer: { value: null },
                accelBuffer1: { value: null },
                accelBuffer2: { value: null },
                collisionBuffer: { value: e.collisionBuffer },
                dt: { value: 1 },
                numCells: { value: e.numCells },
                cellSize: { value: e.cellSize },
    ...
    (SPHWallColliderMaterial = function () {
        THREE.ShaderMaterial.call(this, {
            uniforms: { numCells: { value: null }, cellSize: { value: 0 }, wallExtent: { value: null } },
            vertexShader: ShaderLibrary.get("sph_quad_vertex"),
